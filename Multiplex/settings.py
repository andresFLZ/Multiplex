...
SECRET_KEY = 'django-insecure-$h2snwkf6_3090fcbskzdc5g*mop#73$hyzmi_@)=@)32m_vk2'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'multiplex_app/static/multiplex_app'),)
# Default primary key field type
# https://docs.djangoproject.com/en/4.1/ref/settings/#default-auto-field

DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'

LOGIN_REDIRECT_URL = reverse_lazy('multiplex_app:Inicio')
LOGOUT_REDIRECT_URL = reverse_lazy('multiplex_app:Inicio')